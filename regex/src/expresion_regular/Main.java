...
public class Main  {
	public static void main(String[] args) {
		try {
			...
			String texto = "Cuando utilice cart@uchos.es de impresión que no de email@mail.tk, " + "es que algunas características impresión de los datos del ej.http://blogspot.com " + "volumen restante, estén disponibles por 192.168.1.1 usar suministro que no sea de api.";
