...
/**
 * Autor -nombre: String (no tiene valor por defecto) -email: String (no tiene
 * valor por defecto) -sexo: char (los posibles valores son ‘m’ o ‘f’)
...
public class Autor {
	...
	public String toString() {
		return "Autor nombre= " + nombre + " " + sexo + " " + fechaNacimiento + " \n";
	}

	public String toString2() {
		return "Autor [nombre=" + nombre + ", email=" + email + ", sexo=" + sexo + ", fechaNacimiento="
				+ fechaNacimiento + "]";
	}
